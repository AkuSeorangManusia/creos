...
export const metadata = {
    ...
    openGraph: {
        ...
        title: "Muhammad Ahsan Sanadi | Dim's Desktop - Interactive Retro Portfolio",
        description:
        ...
        <html lang="en">
            ...
            <body className={`${vt323.variable} antialiased`}>
                ...
                <div className="sr-only">
                    ...
                    <p>
                        Tech enthusiast and aspiring DevOps engineer from
                        Yogyakarta, Indonesia. Passionate about Linux, web
                        development, and building creative projects.
                    </p>
                    <h2>Connect with me</h2>
                    <nav aria-label="Social media links">
                        <a href="https://github.com/AkuSeorangManusia">
                            GitHub
                        </a>
                        <a href="https://www.linkedin.com/in/andimsum/">
                            LinkedIn
                        </a>
                        <a href="https://www.instagram.com/andimsum_">
                            Instagram
                        </a>
